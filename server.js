...
// Toggle removal of @everyone mentions
const stripEveryoneMention = parseInt( process.env.stripEveryoneMention );
...
client.on('message', msg => {
    ...
    if (brimeLangChannels.hasOwnProperty(msg.channel.name)) {
        ...
        if (!msg.webhookID && msg.content) {
            ...
            // strip @everyone is toggle is set
            if( stripEveryoneMention === 1 ) {
                msg.content = msg.content.replace(/@everyone/gi,'');
            }
